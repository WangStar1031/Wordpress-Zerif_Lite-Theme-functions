...
function my_login_logo() { ?>
    <style type="text/css">
        #login h1 a, .login h1 a {
            background-image: url('http://www.deeplearningitalia.com/wp-content/uploads/2017/11/custom_logo.png');
		height:65px;
		width:320px;
...
function custom_loginlogo_url($url) {
    return 'http://www.deeplearningitalia.com';
}
function change_title_on_logo() {
	return 'Powered by Deep Learning Italia - Wang Xing';
}
